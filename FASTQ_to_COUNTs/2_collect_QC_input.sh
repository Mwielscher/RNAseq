...
infiles = system(paste0("awk '{print \$1}' ${dat}all_samples_ok"),intern=T).  ## get list of input files
...
## for every analysed sample load several qc files/log files and note QC metrics in file
